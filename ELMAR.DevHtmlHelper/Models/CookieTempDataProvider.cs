...
namespace ELMAR.DevHtmlHelper.Models
{
    ...
    class CookieTempDataControllerFactory : IControllerFactory
    {
        ...
        public IController CreateController(System.ServiceModel.Channels.RequestContext requestContext, string controllerName)
        {
        ...
        public SessionStateBehavior GetControllerSessionBehavior(System.ServiceModel.Channels.RequestContext requestContext, string controllerName)
        {
            throw new NotImplementedException();
        }
